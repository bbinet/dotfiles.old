...
hi TabWinNum cterm=underline ctermfg=DarkGrey ctermbg=234
hi TabWinNumSel ctermfg=Green ctermbg=Black
hi TabNum term=bold cterm=underline ctermfg=White ctermbg=234
hi TabNumSel term=bold cterm=bold ctermfg=Green ctermbg=Black
hi TabSep ctermbg=234
hi TabSepSel ctermbg=Black
